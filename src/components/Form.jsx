...
const Form = ({ handleClose, setExpenses, editingExpense,setEditingExpense, expenses }) => {
  ...
  return (
    ...
    >
      ...
      <TextField
        ...
        required
      />
      <FormControl variant="outlined" sx={{ m: 1, minWidth: 200 }} required>
        <InputLabel id="categoria">Categoría</InputLabel>
        <Select name="categoria" value={formData.categoria}
        onChange={handleChange(setCategoria)} label="Categoría">
      ...
      <FormControl variant="outlined" sx={{ m: 1, minWidth: 200 }} required>
        ...
        <Select name="frecuencia" label="Frecuencia" value={formData.frecuencia}
